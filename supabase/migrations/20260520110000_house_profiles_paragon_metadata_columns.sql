-- Ensure production house_profiles has every Paragon/MLS cache column
-- referenced by the deployed BrokerOS app code.

ALTER TABLE public.house_profiles
  ALTER COLUMN seller_lead_id DROP NOT NULL;

ALTER TABLE public.house_profiles ADD COLUMN IF NOT EXISTS source text;
